...
'''
creation of the agent to cut grass
'''


class Agent:

    def __init__(self, initial, goal_cut_grass=None):
        self.initial = initial
        self.goal_reward = goal_cut_grass
    ...
    def reward_movement(self, state):
        if isinstance(self.goal_reward, list):
            return None
        else:
...
'''
the node to show how the agent move through the grid
'''
